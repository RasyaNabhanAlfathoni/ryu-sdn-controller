        ...
        try:
            ...
            try:
                ...
                if existing: # Untuk Update data Existing
                    ...
                    if device_type == "access_point":  # access point
                        access_point_data = {
                            "device_id": device_id,
                            "username": data.get("username", "unknown"),
                            "password": data.get("password", ""),
                        ...
                        DeviceRepository.update_access_point(device_id, router_data)
                    ...
                    if device_type == "server":
                        ...
                        DeviceRepository.insert_access_point(acess_point_data)
